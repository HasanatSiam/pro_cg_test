...
@notification_bp.route('/messages/<string:id>', methods=['GET'])
...
@notification_bp.route('/messages/<string:id>', methods=['PUT'])
...
@notification_bp.route('/messages/<string:id>', methods=['DELETE'])
